...
- This project teaches students how to write and balance a chemical equation and identify the reaction type.
- In high school Chemistry, there are several basic (yet critical) skills that students must master.  These include taking quality measurements, performing metric conversions, dealing with significant figures/scientific notation, solving problems using dimensional analysis, writing chemical formulas, and balancing chemical equations.
